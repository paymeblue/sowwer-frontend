  ...
  const items: TabsProps["items"] = [
    {
      key: "projects",
      label: "All Projects",
      children: <ExploreCards cardData={cardData} />,
    },
    {
      key: "widows",
      label: "Widows",
      children: (
        <ExploreCards
          cardData={cardData.filter((data) => data?.category === "Widows")}
        />
      ),
    },
    {
      ...
      children: (
        <ExploreCards
          cardData={cardData.filter((data) => data?.category === "Orphans")}
        />
      ),
    },
    {
      ...
      children: (
        <ExploreCards
          cardData={cardData.filter((data) => data?.category === "Missions")}
        />
      ),
    },
  ];
