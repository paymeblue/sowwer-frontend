...
const items: MenuProps["items"] = [
  ...
  {
    key: "/ministry/payouts",
    icon: <Wallet set="light" />,
    label: (
      <Link
        href="/ministry/payouts"
        className="font-body text-sm font-medium text-inherit"
      >
        Payouts
      </Link>
...
const MinistryAdminSidebar = ({ children }: Props) => {
  ...
  const [current, setCurrent] = useState(
    pathname === "/ministry" ? "/ministry" : pathname
  );
...
export default MinistryAdminSidebar;
