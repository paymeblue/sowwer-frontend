              ...
              >
                <AmountInput
                  props={{
                    ...
                    className: `rounded ${
                      query ? "border bg-[#E6E6E6]" : ""
                    } border-none bg-[#f9f9f9] py-3 outline-none [&>input]:bg-inherit [&>input]:placeholder-[#555] placeholder:[&>input]:text-[12px] placeholder:[&>input]:leading-[15.62px] laptop:placeholder:[&>input]:text-[14px] laptop:placeholder:[&>input]:leading-[17.64px]`,
                  }}
                />
              </Item>
            </Space>
