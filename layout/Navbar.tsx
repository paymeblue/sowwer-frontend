...
const Navbar = () => {
  ...
  return (
    <header className="fixed left-1/2 top-6 z-[1000] mx-auto w-4/5 max-w-[1300px] -translate-x-1/2 rounded-full bg-white py-1 pl-6 pr-2 text-body-1 shadow-navbar">
      <nav className="grid flex-1 grid-cols-3 items-center gap-4">
        ...
        <ul className="flex items-center justify-center gap-2 justify-self-end">
          <Button
            variant="outline"
            size="md"
          ...
          <Button size="md" className="font-montreal font-medium">
            Sign up
          </Button>
        </ul>
      </nav>
