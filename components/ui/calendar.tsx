  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-primary text-accent-foreground hover:bg-primary",
        day_outside:
          "day-outside text-muted-foreground aria-selected:bg-accent/50  hover:bg-primary/50 aria-selected:text-muted-foreground",
